...
hmmsearch -Z 1000 --max --tblout pos_1_strali.out pdb_kunitz_r np_strali.hmm pos_1.fasta
...
echo -e "\nBEST THRESHOLD OBTAINED FROM SET_1 FULL SEQUENCE: $set1_best_evalue_full_seq" > hmm_results_strali.txt
    #SET_2 TEST

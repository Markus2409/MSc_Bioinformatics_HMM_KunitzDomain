...
head -n 190 tmp_random_ok_kunitz.id > tmp_pos_1.id
tail -n 190 tmp_random_ok_kunitz.id > tmp_pos_2.id
...
head -n 286280 tmp_random_sp_negs.id > tmp_neg_1.id
tail -n 286280 tmp_random_sp_negs.id > tmp_neg_2.id
